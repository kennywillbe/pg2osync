...
| `serverless` | `false` | Amazon OpenSearch Serverless profile: skips the refresh and settings calls it rejects. [Never verified against a real collection](sinks/opensearch.md#amazon-opensearch-serverless) |
